...
@app.on_message(
     command(["مبرمج السورس","المطور","مطور السورس","صلاح"])
    & filters.group
    & ~filters.edited
)
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/27e4f9cbdaace0cad95ab.jpg",
        caption=f"""𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒕𝒉𝒆 𝑺𝒐𝒖𝒓𝒄𝒆""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                InlineKeyboardButton("❲ ⁨⁩𝐒𝐀𝐋𝐀𝐇 𝐇𝐄𝐌𝐃𝐀𝐍 ❳", url=f"https://t.me/BK_ZT"),
                ],[
                InlineKeyboardButton(
                        "❲ ⁨⁩𝐒𝐎𝐔𝐑𝐂𝐄 𝐓𝐄𝐋𝐄𝐆𝐎𝐃 ❳", url=f"https://t.me/CR_T2"),
                ]
...
async def khalid(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/864baebbaf269dde16006.jpg",
        caption=f"""[𝑺𝒐𝒖𝒓𝒄𝒆 𝒇𝒐𝒓 𝑺𝒆𝒓𝒗𝒊𝒄𝒆 𝑩𝒐𝒕𝒔](https://t.me/CR_T2)""",
        reply_markup=InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
